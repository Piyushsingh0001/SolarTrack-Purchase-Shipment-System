...
function generatePrintItemsGrid() {
  ...
  html.push(`
    <tr style="font-weight: bold; background-color: #fafafa;">
      ...
      <td style="border: 1px solid #000; text-align: left; padding: 4px;">Total</td>
      <td style="border: 1px solid #000; padding: 4px;"></td>
...
function recalculateOffer() {
  ...
  // Apply Government Subsidy - Display Info ONLY (Calculations are not affected, QR retains Grand Total)
  const subSelect = document.getElementById('qSubsidySelect');
